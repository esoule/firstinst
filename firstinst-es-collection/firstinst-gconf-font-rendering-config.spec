...
Name:           firstinst-gconf-font-rendering-config
Version:        1.3
Release:        4%{?dist}
...
Source200:      gconf-font-rendering-config.sh

Summary:        scripts that enable font hinting, subpixel rendering %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        500    gconf-font-rendering-config.sh
