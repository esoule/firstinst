...
Source200:      vsftpd-config.sh

Summary:        scripts that change vsFTPd server options %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        660    vsftpd-config.sh
