...
Source200:      sshd-config.sh

Summary:        scripts that change SSH server options %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        640    sshd-config.sh
