...
Name:           firstinst-gconf-screensaver-lock-off
Version:        1.3
Release:        4%{?dist}
...
Source200:      gconf-screensaver-lock-off.sh

Summary:        scripts that disable screensaver password in GNOME %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        530    gconf-screensaver-lock-off.sh
