...
Name:           firstinst-NetworkManager-sysctl-fixup
Version:        1.3
Release:        4%{?dist}
...
Source200:      NetworkManager-sysctl-fixup.sh

Summary:        scripts that fix NetworkManager's sysctl processing %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        400    NetworkManager-sysctl-fixup.sh
