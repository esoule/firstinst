...
Name:           firstinst-firstinst-services-off
Version:        1.3
Release:        4%{?dist}
...
Source200:      firstinst-services-off.sh

Summary:        scripts that disable firstinst services %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-late-99         900    firstinst-services-off.sh
