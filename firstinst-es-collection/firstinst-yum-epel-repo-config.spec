...
Name:           firstinst-yum-epel-repo-config
Version:        1.3
Release:        4%{?dist}
...
Source200:      yum-epel-repo-config.sh

Summary:        scripts that change EPEL repository config %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        680    yum-epel-repo-config.sh
