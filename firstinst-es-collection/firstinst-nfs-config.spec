...
Source200:      nfs-config.sh

Summary:        scripts that make NFS friendly to firewalls %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        600    nfs-config.sh
