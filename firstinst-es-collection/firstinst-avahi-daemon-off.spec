...
Name:           firstinst-avahi-daemon-off
Version:        1.3
Release:        4%{?dist}
...
Source200:      avahi-daemon-off.sh

Summary:        scripts that disable avahi-daemon %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        410    avahi-daemon-off.sh
