...
Name:           firstinst-minicom-ttyS0-config
Version:        1.3
Release:        4%{?dist}
...
Source200:      minicom-ttyS0-config.sh

Summary:        scripts that provide default minicom config %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        590    minicom-ttyS0-config.sh
