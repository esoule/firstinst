...
Source200:      inputrc-config.sh

Summary:        scripts that disable beep on CLI %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        580    inputrc-config.sh
