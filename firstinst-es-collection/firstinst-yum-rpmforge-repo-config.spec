...
Name:           firstinst-yum-rpmforge-repo-config
Version:        1.3
Release:        4%{?dist}
...
Source200:      yum-rpmforge-repo-config.sh

Summary:        scripts that change rpmforge repository config %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        690    yum-rpmforge-repo-config.sh
