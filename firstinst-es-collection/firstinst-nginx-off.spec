...
Source200:      nginx-off.sh

Summary:        scripts that disable nginx service %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        610    nginx-off.sh
