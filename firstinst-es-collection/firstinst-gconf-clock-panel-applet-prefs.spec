...
Name:           firstinst-gconf-clock-panel-applet-prefs
Version:        1.0
Release:        1%{?dist}
...
Source200:      gconf-clock-panel-applet-prefs.sh
...
(24 hour format, date, seconds, no temperature, no weather),
...
%_fi_inst_file    firstinst-early-02        530    gconf-clock-panel-applet-prefs.sh

%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        530    gconf-clock-panel-applet-prefs.sh
