...
Source200:      root-gitconfig.sh

Summary:        scripts that provide .gitconfig for root user %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        630    root-gitconfig.sh
