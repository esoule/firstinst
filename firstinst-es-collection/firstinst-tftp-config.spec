...
Source200:      tftp-config.sh

Summary:        scripts that change TFTP server options %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        650    tftp-config.sh
