...
Source200:      prelink-off.sh

Summary:        scripts that provide config that disables prelink %firstinst_summary_suffix
...
%files
%defattr(-,root,root,-)
%_fi_file_entry   firstinst-early-02        620    prelink-off.sh
